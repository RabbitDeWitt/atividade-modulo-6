...
export const AppProvider = ({ children }) => {
  ...
  const [reserva, setReserva] = useState({ id: 0, cliente: { ...clientes[0] }, destino: { ...destinos[0] }, pacoteId: { ...pacotes[0] }, pacote: { ...pacotes[0] }, dataPartida: '', dataRetorno: '', valor: 0 })
